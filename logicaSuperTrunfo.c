...
int main()
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        printf("\n \n=----------------------------------------------------= \n");
        printf("(%d/2) Escolha um valor que pretende comparar:\n",valorDaVez);
        ...
        (valorDaVez < 2) ? (scanf("%d", &Comparar)) : scanf("%d", &Comparar2);
        (valorDaVez < 2) ? (valorDaVez++) : (valorDaVez);
    }

    // Comparar os valores escolhido entre as cartas:
    switch (Comparar)
    {
    case 1:
        printf("\n \n=----------------------------------------------------= \n");
